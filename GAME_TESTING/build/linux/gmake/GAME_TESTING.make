...
ifeq ($(config),debug64)
  ...
  TARGETDIR  = ../../../bin
  TARGET     = $(TARGETDIR)/GAME_TESTINGd
...
ifeq ($(config),profile64)
  ...
  TARGETDIR  = ../../../bin
  TARGET     = $(TARGETDIR)/GAME_TESTINGp
...
$(OBJDIR)/GAME_TESTING.o: ../../../src/GAME_TESTING.cpp
	@echo $(notdir $<)
